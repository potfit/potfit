...
/* used to see that the published parameters are correct*/
...
printf("flag2");
for (i = 0; i < 32; i++)
{ printf("%f %f %f\n",calc_pot.table[i],xi[i],neigh->step[0]);}
...
*/
/*
printf("potfit pair force neigh %3d %20.15f\t%25.20f\t%25.20f\t%25.20f\n%78.20f\n%78.20f\n",j,neigh->r,phi_val,phi_grad, tmp_force.x, tmp_force.y, tmp_force.z);
*/
/*
printf("%3d %20.15f %25.20f %25.20f %25.20f\n",j,neigh->r,phi_val,phi_grad, tmp_force.x);

printf("%3d %20.15f %25.20f %25.20f %25.20f\n",j,neigh->r,phi_val,phi_grad, tmp_force.y);

printf("%3d %20.15f %25.20f %25.20f %25.20f\n",j,neigh->r,phi_val,phi_grad, tmp_force.z);
*/
...
/*
printf("potfit forces neigh %3d %20.15f\t%20.15f\t%20.15f\t%f\n%62f\n%62f\n",j,neigh->r,phi_val, phi_grad, neigh->dist_r.x*neigh->r, neigh->dist_r.y*neigh->r,neigh->dist_r.z*neigh->r);

*/
/*
printf("potfit forces neigh %3d %20.15f\t%30.20f\t%30.20f\n%62.20f\n%62.20f\n",j,neigh->r, phi_grad, neigh->dist_r.x, neigh->dist_r.y,neigh->dist_r.z);
*/
...
printf("density from potfit %20.15f\n",rho_val);
...
/*
 rho_val =
	      splint_comb(&calc_pot, xi, col_F, calc_pot.end[col_F],
	      &atom->gradF);
...
/*
printf("potfit eam force neigh %3d %20.15f\t%25.20f\t%25.20f\t%25.20f\n%78.20f\n%78.20f\n",j,neigh->r,phi_val,phi_grad, tmp_force.x, tmp_force.y, tmp_force.z);
*/
...
/*
printf("potfit forces each step %3d %f\n\t%f\n\t%f\n",j, tmp_force.x, tmp_force.y, tmp_force.z);
*/
...
/*
printf("flag tmpsum of forces from potfit %25.15f\n", tmpsum);
*/
/* uinttest ends */
...
/* used together with `printf("flag tmp_sum of forces from potfit %f\n",tmpsum);' 
 ...
 as the potfit built-in ones.  */
/*
printf("flag tmpsum of energy from potfit %25.15f\n", tmpsum);
*/
/* uinttest ends */
...
/* used together with `printf("flag tmp_sum of forces from potfit %f\n",tmpsum);' 
 ...
 as the potfit built-in ones.  */
/*
printf("flag kimtmp_sum of forces from kim %25.15f\n", kim_tmpsum);
*/
/* uinttest ends */
...
/* used together with `printf("flag tmp_sum of energy from potfit %f\n",tmpsum);' 
 ...
 as the potfit built-in ones.  */
/*
printf("flag kimtmp_sum of energy from kim %25.15f\n", kim_tmpsum);
*/
/* uinttest ends */

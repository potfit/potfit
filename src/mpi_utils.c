...
void broadcast_params_mpi()
{
  ...
  size = 0;
  blklens[size] = 1;
  typen[size++] = MPI_INT; /* type */
  blklens[size] = 1;
  typen[size++] = MPI_INT; /* nr */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* r */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* r2 */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* inv_r */
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_VECTOR; /* dist */
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_VECTOR; /* dist_r */
  blklens[size] = SLOTS;
  typen[size++] = MPI_INT; /* slot */
  blklens[size] = SLOTS;
  typen[size++] = MPI_DOUBLE; /* shift */
  blklens[size] = SLOTS;
  typen[size++] = MPI_DOUBLE; /* step */
  blklens[size] = SLOTS;
  typen[size++] = MPI_INT; /* col */
#ifdef ADP
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_STENS; /* sqrdist */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* u_val */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* u_grad */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* w_val */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* w_grad */
#endif                        /* ADP */
#ifdef COULOMB
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* fnval_el */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* grad_el */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* ggrad_el */
#endif                        /* COULOMB */
#ifdef THREEBODY
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* f */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* df */
  blklens[size] = 1;
  typen[size++] = MPI_INT; /* ijk_start */
#endif                     /* THREEBODY */
#ifdef MEAM
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* drho */
#endif                        /* MEAM */
#ifdef TERSOFF
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_VECTOR; /* dzeta */
#endif                              /* TERSOFF */
  ...
  typen[size++] = MPI_DOUBLE; /* step */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* g */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* dg */
#endif                        /* MEAM */
  ...
  typen[size++] = MPI_INT; /* type */
  blklens[size] = 1;
  typen[size++] = MPI_INT; /* num_neigh */
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_VECTOR; /* pos */
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_VECTOR; /* force */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* absforce */
  blklens[size] = 1;
  typen[size++] = MPI_INT; /* conf */
#ifdef CONTRIB
  blklens[size] = 1;
  typen[size++] = MPI_INT; /* contrib */
#endif                     /* CONTRIB */
#if defined EAM || defined ADP || defined MEAM
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* rho */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* gradF */
#endif                        /* EAM || ADP || MEAM */
#ifdef ADP
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_VECTOR; /* mu */
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_STENS; /* lambda */
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* nu */
#endif                        /* ADP */
#if defined DIPOLE
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_VECTOR; /* E_stat */
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_VECTOR; /* p_sr */
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_VECTOR; /* E_ind */
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_VECTOR; /* p_ind */
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_VECTOR; /* E_old */
  blklens[size] = 1;
  typen[size++] = g_mpi.MPI_VECTOR; /* E_tot */
#endif                              /* DIPOLE */
#ifdef THREEBODY
  blklens[size] = 1;
  typen[size++] = MPI_INT; /* num_angl */
#ifdef MEAM
  blklens[size] = 1;
  typen[size++] = MPI_DOUBLE; /* rho_eam */
#endif                        /* MEAM */
#endif                        /* THREEBODY */
  ...
  MPI_Scatterv(g_config.useforce, g_mpi.conf_len, g_mpi.conf_dist, MPI_INT,
               g_config.conf_uf, g_mpi.myconf, MPI_INT, 0, MPI_COMM_WORLD);
#ifdef STRESS
  MPI_Scatterv(g_config.usestress, g_mpi.conf_len, g_mpi.conf_dist, MPI_INT,
               g_config.conf_us, g_mpi.myconf, MPI_INT, 0, MPI_COMM_WORLD);
#endif /* STRESS */

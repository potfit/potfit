	    ...
	    output_controls *out_control )
{
  ...
  for( i = 0; i < natoms; ++i ) {
	...
	double De_sh = vsymm * twbp->De_s;
	double De_ph = vsymm * twbp->De_p;
	double De_pph = vsymm * twbp->De_pp;
	...
	bo_ij->Cdbo += CEbo;
	bo_ij->Cdbopi -= De_ph;
	bo_ij->Cdbopi2 -= De_pph;
	      
//#ifdef TEST_ENERGY
	//fprintf( out_control->ebond, "%6d%6d%24.15e%24.15e%24.15e\n",
	/*        fprintf(out_control->ebond, "%6d%6d%6d%6d%12.4f%12.4f%12.4f\n",i,j,
...
//#endif
  ...
  //fclose(pFile);
  //printf ("Total bond energy: %10.4f\n", data->my_en.e_bond);

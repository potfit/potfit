...
/*printf("Overcoordination: %6d%12.4f%12.4f\n",
             system->my_atoms[i].orig_id,
             e_ov, data->my_en.e_ov + data->my_en.e_un );

 printf("Undercordination: %6d%12.4f%12.4f\n",
             system->my_atoms[i].orig_id,
             e_un, data->my_en.e_ov + data->my_en.e_un );*/

  }

 //printf("Over., Under.: %12.4f%12.4f%12.4f\n",
   //          data->my_en.e_ov, data->my_en.e_un, data->my_en.e_ov + data->my_en.e_un );
}

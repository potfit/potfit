			...
			mpi_datatypes *mpi_data )
{
  ...
  for( i = 0; i < system->n; ++i ) {
	...
	fprintf(pFile, "Energy\nbe: %f\nlp: %f\nov: %f\nun: %f\nang: %f\npen: %f\ncoa: %f\ntor: %f\ncon: %f\nvdw: %f\nele: %f\nhb: %f\n",  workspace->f_be[i][d], workspace->f_lp[i][d], workspace->f_ov[i][d], workspace->f_un[i][d], workspace->f_ang[i][d], workspace->f_pen[i][d], workspace->f_coa[i][d], workspace->f_tor[i][d], workspace->f_con[i][d], workspace->f_vdw[i][d], workspace->f_ele[i][d], workspace->f_hb[i][d]);

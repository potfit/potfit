...
//fprintf(pFile, "%d %d %d CEval4: %f, CEval8: %f, sin_theta: %f, theta: %f, sin(theta): %f\n", type_i, type_j, type_k, CEval4, CEval8, sin_theta, theta, sin(theta));
...
//fprintf(pFile, "%3d %3d %3d %6d %12.8f %12.8f %12.8f %12.8f\n",
  //                   pi, j, pk, t, CEval8, p_ijk->dcos_di, p_ijk->dcos_dj, p_ijk->dcos_dk);
 ...
 /*printf(  "BE: %6d%6d%6d%12.4f%12.4f%12.4f%12.4f%12.4f%12.4f\n", system->my_atoms[i].orig_id, system->my_atoms[j].orig_id,system->my_atoms[k].orig_id,  RAD2DEG(theta), theta_0, BOA_ij, BOA_jk, e_ang, data->my_en.e_ang );*/
...
//#if defined(DEBUG)
 ...
 // printf ( "Angle Energy: %g\t Penalty Energy: %g\t Coalition Energy: %g\t\n",

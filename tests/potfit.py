...
class Potfit:
    ...
    def create_config_file(self, **kwargs):
        ...
        if 'contrib' in kwargs and int(kwargs['contrib']):
           f.write('#B_O {} {} {}\n'.format(0, 0, 0))
           f.write('#B_A {} {} {}\n'.format(repeat_cell * basic_size * 0.5, 0, 0))
           f.write('#B_B {} {} {}\n'.format(0, repeat_cell * basic_size * 0.5, 0))
           f.write('#B_C {} {} {}\n'.format(0, 0, repeat_cell * basic_size * 0.5))

...
def test_apot_stiweb_basic(potfit):
    potfit.create_param_file()
    potfit.call_makeapot('startpot', '-i stiweb')
...
def test_apot_stiweb_wrong_number_of_potentials(potfit):
    potfit.create_param_file()
    potfit.create_potential_file('''
#F 0 2
#T STIWEB
...
''')
    ...
    potfit.run()
    assert potfit.has_error()
    assert 'Wrong number of data columns in STIWEB potential file' in potfit.stderr
    assert 'there should be 3, but there are 2' in potfit.stderr

def test_apot_stiweb_wrong_potential_type(potfit):
    potfit.create_param_file()
    potfit.create_potential_file('''
#F 0 3
#T PAIR
...
''')
    ...
    assert 'This binary only supports STIWEB potentials' in potfit.stderr

def test_apot_stiweb_wrong_number_of_invariant_entries(potfit):
    potfit.create_param_file()
    potfit.create_potential_file('''
#F 0 3
#T STIWEB
...
def test_apot_stiweb_no_header_end_line(potfit):
    potfit.create_param_file()
    potfit.create_potential_file('''
#F 0 3
#T STIWEB
...
def test_apot_stiweb_unknown_potential_function(potfit):
    potfit.create_param_file()
    potfit.create_potential_file('''
#F 0 3
#T STIWEB
...
def test_apot_stiweb_no_potential_function(potfit):
    potfit.create_param_file()
    potfit.create_potential_file('''
#F 0 3
#T STIWEB
...
def test_apot_stiweb_invalid_keyword(potfit):
    potfit.create_param_file()
    potfit.create_potential_file('''
#F 0 3
#T STIWEB
...
def test_apot_stiweb_not_enough_params(potfit):
    potfit.create_param_file()
    potfit.create_potential_file('''
#F 0 3
#T STIWEB
...
def test_apot_stiweb_not_enough_param_values(potfit):
    potfit.create_param_file()
    potfit.create_potential_file('''
#F 0 3
#T STIWEB
...
def test_apot_stiweb_not_enough_potentials(potfit):
    potfit.create_param_file()
    potfit.create_potential_file('''
#F 0 3
#T STIWEB
